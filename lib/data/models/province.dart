/*
  isinya data class
  membuat constructor otomatis :
  - kursor mouse taruh di variabel
  - ctrl + .
  - pilih Generate constructor atau create constuctor
    for final field, require named
*/
...
class Province {
  ...
  //constuctor untuk inisialisasi nilai object
  Province({
    required this.id,
    required this.nama,
